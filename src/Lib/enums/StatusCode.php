...
/**
 * HTTP Status Code enumeration according to
 * {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Status mdn web docs}
 */
enum StatusCode: int
{
    /**
    ...
    /**
     * This code is sent in response to an {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Upgrade Upgrade}
    ...
    /**
     * This status code is primarily intended to be used with the {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Link Link}
     * header, letting the user agent start {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/rel/preload preloading}
    ...
    /**
     * This response code is used when the {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Range Range}
    ...
    /**
     * The request has more than one possible response. The user agent or user should choose one of them. (There is
     ...
     * the URI might be made in the future. Therefore, this same URI should be used by the client in future requests.
     */
    case FOUND = 302;
    ...
    /**
     * The server cannot or will not process the request due to something that is perceived to be a client error (e
     * .g., malformed request syntax, invalid request message framing, or deceptive request routing).
     */
    ...
    /**
     * The server cannot find the requested resource. In the browser, this means the URL is not recognized. In an
     * API, this can also mean that the endpoint is valid but the resource itself does not exist. Servers may also
     * send this response instead of 403 Forbidden to hide the existence of a resource from an unauthorized client.
     ...
     * {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Content_negotiation#server-driven_negotiation server-driven content negotiation}
    ...
    /**
     * This response code means the expectation indicated by the Expect request header field cannot be met by the
     * server.
     */
     ...
     * {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Upgrade Upgrade} header in a 426 response to
     ...
     * be sent. This response should be used for temporary conditions and the Retry-After HTTP header should, if
