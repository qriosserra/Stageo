...
enum Action: string
{
    ...
    case ENTREPRISE_AFFICHER_OFFRE = "?c=entreprise&a=mesOffres";
    ...
    case ENTREPRISE_DELETE = "?c=entreprise&a=delete";
    ...
    case ETUDIANT_CONVENTION_ADD_STEP_4_FORM = "?c=etudiant&a=conventionAddStep4Form";
    case ETUDIANT_CONVENTION_ADD_STEP_4 = "?c=etudiant&a=conventionAddStep4";
    ...
    case ADMIN_OFFRESARCHIVE = "?c=admin&a=offreArchive";
    case ADMIN_SUPRIMEROFFRESARCHIVE = "?c=admin&a=suprimerOffreArchive";
