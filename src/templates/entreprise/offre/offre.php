...
<div class="flex flex-col md:flex-row justify-center items-center md:space-x-4">
        ...
        <button onclick="window.location.href='<?= Action::ENTREPRISE_DELETE_OFFRE->value ?>&id=<?= $offre->getIdOffre() ?>'" class="px-4 py-2 bg-red-500 text-white text-sm font-bold uppercase rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 transition duration-150 ease-in-out">Supprimer</button>
    <?php endif ?>
