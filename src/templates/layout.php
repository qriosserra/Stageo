                ...
                <nav class="bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-200">
                    <div class="max-w-screen-xl flex flex-wrap md:pl-4 md:pr-4 items-center justify-between mx-auto md:p-0 p-4">
                        ...
                        <div class="flex md:order-2">
                            <?php if (!UserConnection::getSignedInUser() instanceof Etudiant) {
                                echo "
...
<!--                            bouton pour le formulaire de depot de convention : -->
                            <?php if
                                (UserConnection::getSignedInUser() instanceof Etudiant) {
                                echo
                                "<a href ='"
                                .  Action::ETUDIANT_CONVENTION_ADD_FORM->value .
                            "' class='space-x-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' >
                                    <i class='fi fi-rr-sign-in-alt flex align-middle text-lg float-left' ></i >
                                    <span > Déposer une convention </span >
                                </a>";
                                }
                                ?>
                            <?php if
                                (UserConnection::getSignedInUser() instanceof Etudiant) {
                                echo "<a href ='".Action::ADMIN_LISTE_CONVENTIONS->value."' class='space-x-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' >
                                    <i class='fi fi-rr-sign-in-alt flex align-middle text-lg float-left' ></i >
                                    <span > Liste des conventions </span ></a>";                           }
                                ?>
                        </div>
                        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white  dark:border-gray-700">
                                ...
                                <li class="relative">
                                    ...
                                    <div class="absolute block opacity-0 bg-white invisible active:opacity-100 active:visible text-gray-700 pt-1 border border-slate-300 "
                                ...
                                <li class="relative ">
                                    ...
                                    <div id="dropdownContentEntreprise" class="block opacity-0 absolute bg-white invisible active:opacity-100 active:visible text-gray-700 border border-slate-300 w-[520px] h-[450px] right-0">
                                        <div class="flex flex-wrap -mx-2">
                                            <a href="http://www.google.com" class="w-1/2 p-4" target="_blank"
                                               rel="noopener noreferrer">
                                                <a href="<?=Action::ENTREPRISE_SIGN_IN_FORM->value?>" class="p-[1%] mr-3 hover:bg-gray-50 pointer transition-all">
                                                    <span class="font-bold">Connectez-vous à l'Espace Entreprise</span>
                                                    <p>
                                                        Administrez les opportunités de stage et d'alternance de votre entreprise, consultez et réagissez aux retours des candidats.
                                                    </p>
                                                </a>
                                            </a>
                                            <a href="http://www.google.com" class="w-1/2 p-4" target="_blank"
                                               rel="noopener noreferrer">
                                                <div class="p-[1%] h-full hover:bg-gray-50 pointer transition-all">
                                                    <span class="font-bold">Vous voulez proposer des offres ?</span>
                                                    <p class="mt-2">
                                                        Rejoignez notre plateforme dynamique et rencontrez des candidats talentueux prêts à s'engager dans des stages et alternances enrichissants.
                                                    </p>
                                                </div>
                                            </a>
                                            <a href="http://www.google.com" class="w-1/2 p-4" target="_blank" rel="noopener noreferrer">
                                                <div class="p-[1%] hover:bg-gray-50 pointer transition-all">
                                                    <span class="font-bold">
                                                        Besoin d'Information? Contactez l'IUT et le Secrétariat!
                                                    </span>
                                                    <p class="mt-2">
                                                        Contactez notre secrétariat ou les administrateurs pour aide et infos sur les formations et candidatures.
                                                    </p>
                                                </div>
                                            </a>
                                            <div class="w-1/2 p-4">
