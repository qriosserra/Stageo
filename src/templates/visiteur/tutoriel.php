...
<main class="container mx-auto p-8">
    <div class="bg-gray-100 p-8 rounded-md flex flex-col items-center mb-8">
        <div class="md:w-1/2 md:mr-8 text-center">
            ...
            <p class="text-gray-700 mb-4">Vous êtes un étudiant, un enseignant ou une entreprise et vous ne savez pas comment vous connecter à votre compte ? Suivez ce tutoriel.</p>
        </div>
    </div>
    ...
    <div class="bg-gray-100 p-8 rounded-md flex flex-col md:flex-row items-center mb-8">
        ...
        <div class="md:w-1/2 flex justify-center items-center">
            <div class="flex flex-col items-center">
                <img src="assets/img/indication_connexion.png" alt="Emplacement du bouton" class="w-3/4 md:w-full rounded-md shadow-md">
                <img src="assets/img/bouton_connexion.png" alt="Bouton de connexion" class="w-3/4 md:w-full rounded-md shadow-md">
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-100 p-8 rounded-md flex flex-col md:flex-row items-center mb-8">
        ...
        <div class="md:w-1/2 flex justify-center items-center">
            <div class="flex flex-col items-center">
                <img src="assets/img/connexion_entreprise.png" alt="Emplacement du lien" class="w-3/4 md:w-full rounded-md shadow-md">
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-100 p-8 rounded-md flex flex-col md:flex-row items-center mb-8">
        ...
        <div class="md:w-1/2 flex justify-center items-center">
            <div class="flex flex-col items-center">
                <img src="assets/img/inscription_entreprise.png" alt="Emplacement du lien" class="w-3/4 md:w-full rounded-md shadow-md">
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-100 p-8 rounded-md flex flex-col md:flex-row items-center">
        ...
        <div class="md:w-1/2 flex justify-center items-center">
            <img src="assets/img/inscription_etape4_entreprise.png" alt="Dernière page d'inscription" class="w-3/4 md:w-full rounded-md shadow-md">
        </div>
    </div>
    <div class="bg-gray-100 p-8 rounded-md flex flex-col items-center mb-8">
        <div class="md:w-1/2 md:mr-8 text-center">
