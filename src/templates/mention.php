<main>
<div class="w-full py-12 md:py-24 lg:py-32 xl:py-48 flex ">
  <div class="container px-4 md:px-6">
    <div class="flex flex-col items-center space-y-4 text-center">
      <div class="space-y-2">
        <h1 class="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">Mentions légales</h1>
        <p class="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">Informations légales sur Stageo</p>
      </div>
      <div class="w-full max-w-sm space-y-2">
        <p class="text-sm/relaxed"><strong>Nom de l'organisme :</strong> Stageo</p>
        <p class="text-sm/relaxed"><strong>Adresse de l'organisme :</strong> 90 avenue d'occitanie, Montpellier, France</p>
        ...
        <p class="text-sm/relaxed"><strong>Politique de cookies :</strong> La politique de cookies de Stageo est disponible sur demande.</p>
      </div>
    </div>
  </div>
  </main>