...
class Entreprise extends User
{
    public function __construct(#[PrimaryKey] private ?int       $id_entreprise = null,
                                ...
                                private bool|NullDataType|null   $valide = null)
    {
    }
    ...
    public function getValide(): bool|NullDataType|null
    {
        return $this->valide;
    }

    public function setValide(bool|NullDataType|null $valide): void
    {
        $this->valide = $valide;
    }
}